...
const en = {
  ...
  studio: {
    ...
    sec: {
      ...
      overnight: "Overnight (US)",
      risk: "Risk & notes",
    },
    overnightEmpty: "No headlines available right now.",
    overnightTitle: "What happened overnight",
...
const ko: Dict = {
  ...
  studio: {
    ...
    overnightEmpty: "지금은 표시할 헤드라인이 없습니다.",
    overnightTitle: "밤사이 무슨 일이",
